<?php
$customer_list = array(
    "1" => array("name" => "Mai Văn Hoàn", "day_of_birth" => "1983/08/20", "address" => "Hà Nội", "profile" => "img/hoang.jpg"),
    "2" =>array("name" => "Nguyễn Văn Nam", "day_of_birth" => "1983/08/21", "address" => "Bắc Giang", "profile" => "img/loc.jpg"),
        ...
        <table border="0">
          ...
          <?php foreach($filtered_customers as $index=> $customer): ?>
            <tr>
                ...
                <td><div class="profile"><img style="width: 60px; height: 60px" src="<?php echo $customer['profile'];?>"/></div> </td>
            </tr>
            <?php endforeach; ?>
        </table>
</body>
